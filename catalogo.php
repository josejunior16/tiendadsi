...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logomuebles.jpg" type="image/x-icon">
...
<body>
        ...
        <div class="align-center container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <h1 class="mbr-section-title mb-4 mbr-fonts-style display-1"><strong>DANDO VIDA A TU HOGAR</strong></h1>
    ...
    <section data-bs-version="5.1" class="gallery5 mbr-gallery cid-tlBU6GDLFH" id="gallery5-1q">
        <div class="container">
            <div class="mbr-section-head">
                <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">Seleccione una
                    Categoria</h4>
            </div>
        </div>
    </section>
    ...
    <div class="row mb-5">
        <?php 
                              ...
                              $resultado=$conexion -> query("select * from categorias order by id ASC")or die($conexion -> error);
        ...
        <div class="col-sm-6 col-lg-4 mb-4 center" data-aos="fade-up">
            <div class="block-4 text-center border">
                ...
                <div class="block-4-text p-4">
                    <a href="productos.php?id=<?php echo $fila['id'];?>"><img class="pequeña mb-0"
                            src="http://localhost/admintienda/public/<?php echo $fila['imagen'];?>"></a>

                   <a href="productos.php?id=<?php echo $fila['id'];?>"><?php echo $fila['nombre'];?></a></p>
                    <p class="mb-0"><?php echo$fila['nombre'];?></p>
                    <p class="mb-0"><?php echo $fila['descripcion'];?></p>
                    <button type="button" class="btn btn-dark"><a href="productos.php?id=<?php echo $fila['id'];?>">Ver</a></button>
                </div>
            </div>
        </div>
        <?php } ?>
